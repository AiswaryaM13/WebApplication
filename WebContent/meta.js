...
function handleResult(resultData) {
    ...
    console.log("handleResult: populating meta info from resultData");
//
...
//        "<p>Date Of Birth: " + resultData[0]["star_dob"] + "</p>");
    ...
    let movieTableBodyElement = jQuery("#metadata_body");
    ...
    for (let i = 0; i < (resultData.length); i++) {
        ...
        rowHTML += "</tr>";
        if(i!=resultData.length-1 && (resultData[i]["table"]!=(resultData[i+1]["table"]))){
        	rowHTML += "<tr>";
            rowHTML += "</tr>";
            rowHTML += "<tr>";
            rowHTML += "</tr>";
