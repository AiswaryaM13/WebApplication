...
public class SingleStarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String query = "SELECT distinct s.id as star_id, s.name as star_name, s.birthyear, m.title, m.id as movieId, m.year, m.director from stars as s, stars_in_movies as sim, movies as m where m.id = sim.movieId and sim.starId = s.id and s.id = ?";
